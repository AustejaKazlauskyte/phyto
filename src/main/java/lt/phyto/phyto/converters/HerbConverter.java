...
public class HerbConverter {
    ...
    public HerbConverter(CharacteristicConverter characteristicConverter, MedicalConditionConverter medicalConditionConverter) {
    ...
    public HerbEntity convertToEntity(Herb herb) {
        ...
        result.setMedicalConditions(medicalConditionConverter.convertToEntity(herb.getMedicalConditions()));
    ...
    public Herb convert(HerbEntity herbEntity) {
        ...
        result.setMedicalConditions(medicalConditionConverter.convert(herbEntity.getMedicalConditions()));
